...
public class CarMove : MonoBehaviour
{
    ...
    void PoCheck()//检测坡
    {
        ...
        Vector3 tempPos = transform.rotation * Vector3.forward * (20+addSpeed-weight*friction) * 0.1f;
        ...
        if(realPos.y>nextPos.y)//上坡
        {
            ...
            {
                carSpeed = Mathf.Sqrt(xiebian * xiebian - zhibian * zhibian)*9;//速度（稍微把影响改的大一点） 
            }
            else
            {
                carSpeed = 20;
